...
export default function Listing() {
  ...
  const params = useParams(); // Corrected destructuring
        ...
        <div>
          ...
          <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
            ...
            <div className="">
              ...
              {/* discounted prices comes as undefined here */}
              {/* {listing.offer ? (
                <p className="bg-red-900 w-full max-w-[200px] text-white text-center p-1 rounded-md">
                  Rs. {listing.discountPrice?.toLocaleString("en-US")}
                  {console.log(typeof listing.discountPrice)}
                  {console.log(typeof listing.regularPrice)}
