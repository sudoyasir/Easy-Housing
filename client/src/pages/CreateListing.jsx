...
export default function CreateListing() {
  ...
  const handleImageSubmit = (e) => {
    if (files.length > 0 && files.length < 6 + formData.imageUrls.length) {
      setUploading(true);
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              type="button"
              className="p-3 text-green-700 border border-green-700 rounded uppercase hover:shadowo-lg disabled:opacity-80"
            >
